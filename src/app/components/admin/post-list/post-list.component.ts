...
@Component({
  ...
  styleUrls: ['./post-list.component.css','../../../../../node_modules/admin-lte/bower_components/bootstrap/dist/css/bootstrap.min.css',
...
export class PostListComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.get('https://ibigo.shadowis.nl/server-api/api/admin/checkin/list').subscribe((data)=>{
      if(data['status']==true){
